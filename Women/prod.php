...
?>
                                        ...
                                        <br>
                                           ...
                                           <button  type="submit" style="color: white; border-radius: 34px; border: none ;background-color:#CC5C7D ;padding: 8px; width: 135px;  font-size: 21px;margin-bottom: 60px;" >Go <img src="arrowRightSmall.png" alt="" style="width: 13px;"></button><br>
                                          </form>
                                          <?php
                              $username = "root";
                              $password = "";
