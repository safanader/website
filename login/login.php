    ...
    <div class="row "  style="text-align: -webkit-center;  " >
     <div class="col-12  " >
                ...
                <div class="row " style="text-align: -webkit-center; " >
                    <div class="col-12">
                        <form method="POST">
                        <input type="text" placeholder="Email" name="email" size="50" style="border-radius: 20px; background:#ffffff ;  padding: 10px; width: 100% ;margin-top: 20px;    border: none;box-shadow: 0 0 10px -6px; " required> 
</div>
          </div><br/>
                <div class="row " style="text-align: -webkit-center;"  >
                    <div class="col-12">
                        <input type="password" name="password" placeholder="Password" style="border-radius: 20px; background:#ffffff ;  padding: 10px; width: 100% ; margin-top: 20px;    border: none;box-shadow: 0 0 10px -6px;" required>
                    </div>
                </div>
                <div class="row" style="text-align: right; "  >
                    <div class="col-12" > 
                        <a  href="reset.php" style="color:#F5EBEF; text-decoration: none; font-size:13px;margin-top: 5px;" >Forget password? </a> 
                    </div>
                </div>
                <div class="row" style="text-align: center; "  >
                    <div class="col-12" > 
                        <button type="submit" name="login" style="background-color:#603A44; color: white; border-radius:20px; padding: 5px; width: 150px; border: none; ">
                                sign in
                ...
                <div class="row" style="text-align: -webkit-center; "  >
                    <div class="col-12" > 
                        <p type="text" id="text" style="color: #ffffff ; font-size:15px; font-weight: bold;font-family: Tahoma;margin-top: 10px; " >
                            ...
                            <a href="../register/register.php" style="color:#603A44; text-decoration: none;"> Sign up Now</a>
                        </p>
...
$login = $database->prepare("SELECT * FROM register WHERE email = :email AND password = :password");
...
$_SESSION['user']= $User;
if($User->ROLE ==="USER"){
header('location:http://localhost/website/product/product.php');
ob_end_flush();
}else{
    echo "error";
}
   ...
   يرجى تفعيل حسابك في البداية , لقد ارسلنا رمز تحقق من حسابك الى بريد الكتروني الخاص بك</div>';
}
}else{
    echo  '<div class="alert alert-danger" role="alert">
    error password or email</div>';
}}
