...
<body>
                                            ...
                                            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo03" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation">
                                             ...
                                             <div class="collapse navbar-collapse" id="navbarTogglerDemo03" style="margin-left: -128px;">
                                               <ul class="navbar-nav mr-auto mt-2 mt-lg-0" style=" color: #603A44 !important;">
                                                 ...
                                                 <li class="nav-item">
                                                   <a class="nav-link" href="http://localhost/website/AboutUS/AboutUS.php" style=" color: #603A44 !important;font-size: 26px">AboutUs</a>
                                                 </li>
                                                 <li class="nav-item">
  ...
  <button class="btn btn-outline-success my-2 my-sm-0" type="submit" name="logout" style=" border-color: #CC5C7D;color: #CC5C7D;font-size: 20px;">Logout</button>
               ...
               <form method="POST" >    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="text-align: center;">
                         ...
                         <a class="nav-link" href="http://localhost/website/product/product.php">Products</a>
                                                 ...
                                                 <li class="nav-item">
                          <a class="nav-link" href="http://localhost/website/AboutUS/AboutUS.php">AboutUs</a>
                                                 </li>
                                                 <li class="nav-item">
              <select onchange="set_language()" name="language" id="language" style="margin-top: 6px;margin-left: 10px;margin-right: 26px;color: #603a44 !important;font-size: 26px">
