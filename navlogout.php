...
<body>
  ...
  <button class="btn btn-outline-success my-2 my-sm-0" type="submit" name="logout" style=" border-color: #CC5C7D;color: #CC5C7D;font-size: 20px;"><?php echo $row['12']['page_content'] ?></button>;
              ...
              <select onchange="set_language()" name="language" id="language" style="margin-top: 6px;margin-left: 10px;margin-right: 26px;color: #603a44 !important;font-size: 26px">
                   ...
                   <option value="ar"  <?php echo'<link href="bootstrap-rtl.css">'; echo $ar_select?>selected>Ar</option>
                                               ...
                                               <div>
                                                 <button class="btn btn-outline-success my-2 my-sm-0" type="submit" name= "logout" style="border-color: #CC5C7D ;color: #CC5C7D;font-size: 11px;"><?php echo $row['12']['page_content'] ?></button>
