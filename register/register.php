...
<input type="text" name="fname" placeholder="First name " maxlength="50"  style="border-radius: 20px; background:#ffffff ;  padding: 10px; width: 100%; margin-top: 20px;    border: none;box-shadow: 0 0 10px -6px; " size="50"  required />
                ...
                <div class="row " style="text-align: -webkit-center; "  >
                    <div class="col-12">
                <input type="password" name="password" placeholder="Password" style="border-radius: 20px; background:#ffffff ;  padding: 10px; width: 100%; border: none;box-shadow: 0 0 10px -6px;" minlength="8" maxlength="50" required/>
                    </div>
                </div><br/>
                <div class="row " style="text-align: -webkit-center;" > 
                    <div class="col-12">
                        <input type="password" name="confirmpass" placeholder="Password" style="border-radius: 20px; background:#ffffff ;  padding: 10px; width:100%; border: none;box-shadow: 0 0 10px -6px; " minlength="8" maxlength="50" required/>
                    </div>
                </div><br/>
