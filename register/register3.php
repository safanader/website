        ...
        <div class="container-fluid"  > 
            <div class="container"style="text-align: -webkit-center; margin-top: 60px;padding-left: 0;padding-right: 0;" >
                ...
                <div class="row " style="text-align: -webkit-center;"  >
                    ...
                    <div class="col-sm-12 col-md-6" ><form method="POST">
...
<input type="text" name="fname" placeholder="First name " maxlength="50"  style="border-radius: 20px; background:#ffffff ;  padding: 10px; width: 100%; margin-top: 20px;    border: none;box-shadow: 0 0 10px -6px; " size="50"  required />
                ...
                <div class="row " style="text-align: -webkit-center;" > 
                    <div class="col-12">
                        <input type="text" name="confirmpass" placeholder="Password" 
                        style="border-radius: 20px; background:#ffffff ;  padding: 10px; width:100%; border: none;box-shadow: 0 0 10px -6px; " minlength="8" maxlength="50" required/>
                    </div>
                </div><br/>
                ...
                <div class="row" style="text-align: -webkit-center; "  >
                    <div class="col-12" > 
                        <p type="text" id="text" style="color: #ffffff; ; font-size:15px; font-weight: bold;font-family: Tahoma;margin-top: 10px; " >
                            ...
                            <a href="../login/login.php" style="color:#603A44; text-decoration: none;"> Sign in Now</a>
                        </p>
...
if (isset($_POST['register'])){
    ...
    $checkEmail->execute();
      ...
      if($checkEmail->rowCount()>0){
          ...
          $fname= $_POST['fname'] ;if(!preg_match("/^[a-zA-Z\S]+$/",$fname)){
              echo "Please Enter Name As Only String";
          }

          $lname= $_POST['lname'] ;
          $email= $_POST['email'] ; 
          $phone= $_POST['phone'];if(!preg_match("/^[0-9]*$/",$phone)){
              echo "Only Mobile Number ";
          }
          if (strlen($phone<10)){ echo "Please Enter proper Mobile Number Here";}
          if (strlen($phone>14)){ echo "Your Mobile Number is too Large Please Enter Valid...";}
